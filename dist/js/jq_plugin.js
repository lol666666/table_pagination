...
(function($){
    $.fn.tablePagination = function(options){
         ...
         //添加分页
         var pagination_begin = "<ul class=\"pagination\" style='display:block'><li><a href=\"#\" aria-label=\"Previous\"><span aria-hidden=\"true\">&laquo;</span></a></li>";
         var pagination_end = "<li><a href=\"#\" aria-label=\"Next\"><span aria-hidden=\"true\">&raquo;</span></a></li> </ul>";
         var pagination_end = "<li><a href=\"#\" aria-label=\"Next\"><span aria-hidden=\"true\">&raquo;</span></a></li> </ul>";
         var page_input = "<input class='form-control page-input' style='width:40px;display:inline-block;margin-left:10px'/>";
         var pagination_btn = "";
         var pageSizeChoose_begin = '<div class="dropup" style="display:inline-block; margin-left:10px"><button class="btn btn-default dropdown-toggle" type="button" id="dropdownMenu2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Size <span class="caret"></span></button>';
         var pageSizeChoose = '<ul class="dropdown-menu" aria-labelledby="dropdownMenu2"><li><a>10</a></li><li><a>20</a></li><li><a>30</a></li><li><a>40</a></li><li><a>50</a></li><li><a>100</a></li></ul>';
         var pageSizeChoose_end = '</div>';
         ...
         $(table).find("tfoot").append("<tr class='table-pagination'><td colspan='" + tableColumnNum + "'>" + pagination_begin + pagination_btn + pagination_end + page_input  + pageSizeChoose_begin + pageSizeChoose + pageSizeChoose_end+ "</td></tr>")
             .find("ul.pagination li").not(":first,:last").find("a").click(function(){
                                ...
                                if (search_content.length == 0)
                                {
                                    ...
                                    $(table).find("tbody tr").each(function(index){
                                        $(this).find("td").each(function(i){
                                            if($(this).text().indexOf(search_content) != -1)
                                            {
